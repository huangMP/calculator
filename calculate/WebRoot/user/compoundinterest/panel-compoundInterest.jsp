...
<html xmlns="http://www.w3.org/1999/xhtml">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<ul class="nav nav-pills" style="padding-bottom: 10px;"
									...
									<li class="">
										<a href="#repayments-pills" data-toggle="tab" name="4">等额还款</a>
									</li>
								</ul>
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="repayments-pills">
										<h4>
											repayments
										</h4>
										<p>
									...
									<form method="post"
										...
										<table class="table table-bordered"
											style="text-align: center;">
													<tr>	
														...
														<input id="record.calculateBlock" name="record.calculateBlock"
															type="hidden" value="2"></input>
													</tr>
													<tr>
														<td>
															<h4 id="numP_title">
										...
										<input id="sumbitButton" class="form-control btn btn-success" value="submit" onclick="doCheckAll()"/>
									</form>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		function doCheckAll() { //1是求终值     0是求本金  2是求年利率  3是求存入年限  4是求分期付款
			...
			var record_calculateWay = document.getElementById("record.calculateWay").value;
			var record_calculateBlock = document.getElementById("record.calculateBlock").value;
		...
		document.getElementById("ultest").onclick = function(ev){
		   ...
		   switch(oldId) {
		    ...
		    if(id=="4"){
		    	document.getElementById("numP_title").innerHTML = "分期还款（月）";
		    	document.getElementById("numI_title").innerHTML = "贷款利率";
		    	document.getElementById("numN_title").innerHTML = "贷款年限";
		    	document.getElementById("numF_title").innerHTML = "贷款总额";
		    }else{
		    	document.getElementById("numP_title").innerHTML = "本金";
		    	document.getElementById("numI_title").innerHTML = "年利率";
		    	document.getElementById("numN_title").innerHTML = "存入年限";
		    	document.getElementById("numF_title").innerHTML = "终值";
		    }
